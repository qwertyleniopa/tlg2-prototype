<script>
    ...
    $: hasCurrentTurn = playerGameData.currentPlayerIndex == playerGameData.playerIndex;
    ...
    function handleTileClick({ detail: tile }) {
        ...
        const actionIndex = possibleActions.findIndex((a) => Coord.equals(a.targetCoords, tile.coords));
...
<div class="game_view" class:disabled={bannerMessage}>
    ...
    <div class="player_bar" class:disabled={!hasCurrentTurn}>
        ...
        <button 
            class="next_turn_btn" 
            on:click={handleNextTurnBtnClick}
        >
            Next Turn
        </button>
    </div>
